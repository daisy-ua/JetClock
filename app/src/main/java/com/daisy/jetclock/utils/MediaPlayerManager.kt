...
class MediaPlayerManager @Inject constructor(
    ...
    fun prepare(sound: String) {
        try {
            context.assets.openFd(SoundOption.getAssetFilename("Ringtone")).use { soundAfd ->
//            context.assets.openFd(SoundOption.getAssetFilename(sound)).use { soundAfd ->
